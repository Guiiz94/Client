<?php
    ...
    $user = $db ->query('SELECT * FROM client');
...
<main>
    <div class="formulaire">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            ...
            <p> </p>
            <span class="material-symbols-outlined" style="size:20px" onclick="window.location.href='index.php';">shopping_cart</span>
            <p> </p>
        </div>
...
<br>
            ...
            <div class="container">
                <div class="row">
                    <?php
                        $item = $db->query('SELECT * FROM item ORDER BY item_id DESC');
                    ?>
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    ?>
                                            ...
                                            <a href="cart.php?item_id=<?= $Item['item_id']; ?>" class="btn btn-primary">Ajouter au Panier</a>
                                    <?php
                                        }else{
                                    ?>
